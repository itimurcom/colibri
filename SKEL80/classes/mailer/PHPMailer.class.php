...
// ================ CRC ================
// version: 1.35.02
// hash: a9e6f5eb8ec2696e49302817b128e6620b025957e74598b21e9a1ba982a0def7
 ...
 */
  ...
  */
   ...
   * @return string
   */
  protected function GetBoundary($boundary, $charSet, $_CONTENTType, $encoding) {
    $result = '';
    if($charSet == '') {
    ...
    $result .= sprintf("Content-Type: %s; charset=%s", $_CONTENTType, $charSet);
    $result .= $this->LE;
