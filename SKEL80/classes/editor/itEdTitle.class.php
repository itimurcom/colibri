...
// ================ CRC ================
// version: 1.15.02
// hash: d4c140f611bc0d72fe92a764602d2e92903b8ee66fd4dc72a403d1dcb9a6ce97
...
class itEdTitle
	...
	public function __construct($data=NULL)
		...
		$this->no_date 		= (!$_USER->is_logged(itEditor::moderators()) and isset($data['no_date'])) 	? $data['no_date'] 	: DEFAULT_NODATE;
	...
	public function compile()
		...
		if (!isset($this->data['title_xml'])) return;
