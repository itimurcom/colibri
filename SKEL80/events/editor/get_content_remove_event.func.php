...
//..............................................................................
function get_content_remove_event_row_value($row, $key, $default=NULL)
	{
...
function get_content_remove_event($row)
	...
	$table_name = get_content_remove_event_row_value($row, 'table_name');
	$rec_id = (int)get_content_remove_event_row_value($row, 'rec_id', get_content_remove_event_row_value($row, 'id', 0));
	...
	$status = get_content_remove_event_row_value($row, 'status');
	if ($status=='MODERATE')
		{
	...
	$o_form = new itForm2();
	$o_form->add_title(str_replace('[VALUE]', get_field_by_lang(get_content_remove_event_row_value($row, 'title_xml', '')), get_const($query)));
	$o_form->add_data([
