...
// ================ CRC ================
// version: 1.35.07
// hash: 889cdd9b0cb1a52aab7b71b36ec6383a9a20b47363f0c0c644f78761e6494bf0
...
function set_skeleton_user_ways()
	...
	if (!defined('CONTROLLER_DIR'))
		{	
		define('CONTROLLER_DIR', $_SERVER['DOCUMENT_ROOT']."/mvc/controllers/");
		}

	// установим путь к видам
	if (!defined('VIEW_DIR'))
		{	
		define('VIEW_DIR', $_SERVER['DOCUMENT_ROOT']."/mvc/views/");
		}
	...
	if (!defined('USER_CSS_PATH'))
		{	
		define('USER_CSS_PATH', $_SERVER['DOCUMENT_ROOT'].'/themes/'.CMS_THEME.'/css/');
		}
	}
...
//..............................................................................
// установка пути на папки и адреса изображений
//..............................................................................
function register_skeleton_images_ways()
	{
	definition([
