<?
definition([
	'DEFAULT_USER_CHECK'	=> true,
	'DEFAULT_AGENT_CHECK'	=> true,
	]);
//..............................................................................
...
Class itUser
	...
	public function __construct($options=NULL)
		...
		$this->need_check = isset($options['check']) ? $options['check'] : DEFAULT_USER_CHECK;
		$this->check();
		}
	...
	public function check($table_name=DEFAULT_SESSION_TABLE)
		...
		if ( isset($_SESSION[SESSION_PREFIX.'HASH']) )
			...
			if (!is_null($this->session_row))
				...
				// браузер?					
				if ( DEFAULT_AGENT_CHECK AND ($hash_data['user_agent']!=$this->user_agent) )
					{
