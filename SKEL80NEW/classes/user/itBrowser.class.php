...
class itBrowser
{
     ...
     * Class constructor
     */
    public function __construct($agent_of_user = '')
    {
        if ($agent_of_user != '') {
            $this->setUserAgent($agent_of_user);
        } else {
            $this->reset();
            $this->determine();
        }
    ...
    protected function checkPlatform()
    {
     ...
     static function _user_agent()
     	{
     	$browser = new itBrowser();
     	$result = $browser->getBrowser().$browser->getVersion();
     	unset($browser);
     	return $result;
     	}
