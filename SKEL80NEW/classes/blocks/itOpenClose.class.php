...
class itOpenClose
	{
	// public $name, $state, $open_text, $open_class, $close_text, $close_class, $length, $replace, $code, $set, $class, $alert, $closeother;
	//..............................................................................
	...
	public function __construct($code=NULL, $options=NULL)
		...
		$this->closeother	= isset($options['closeother'])	? $options['closeother'] 	: get_const('DEFAULT_CLOSEOTHER');
			...
			if ($size<=$this->length)
				...
				$this->code = $this->content;
					...
					$this->code = 
						...
						$this->content.
						TAB."</div>".
						TAB."<div class='switch' rel-state='{$this->state}' rel='{$this->open_text},{$this->open_class},{$this->close_text},{$this->close_class}'{$close_other}>{$sw_text}</div>".
						TAB."</div>";
					}
			} else	{
				if (!is_null($this->set))
				...
				$this->code = 
					TAB."<div class='openclose{$this->class}' id='{$this->name}'>".
					TAB."<div class='switch'{$dataset} rel-state='{$this->state}' rel='{$this->open_text},{$this->open_class},{$this->close_text},{$this->close_class}' rel-alert='{$this->alert}'{$close_other}>{$sw_text}</div>".
					TAB."<div class='block' rel-eff='{$this->effect}' rel-dur='{$this->duration}'>".
					$this->content.
					TAB."</div>".
					TAB."</div>";
