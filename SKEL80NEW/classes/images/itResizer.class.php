...
class itResizer
	...
	public function compile()
		{
		if (is_dir($this->input_image_name) OR !file_exists($this->input_image_name) OR !filesize($this->input_image_name)) return;
//		if (!file_exists($this->input_image_name)) return;
		...
		switch($image_type)
			{
			case IMAGETYPE_WEBP : {
	         		$img = imagecreatefromwebp($this->input_image_name);
	         		break;
				}
		...
		// ------------------------------------------------------------------
		if ( ($this->logo_name !='') AND file_exists(DOCUMENT_ROOT.$this->logo_name) )
			{
			$img_logo = imagecreatefrompng(DOCUMENT_ROOT.$this->logo_name);
	...
	//		imagecopy($img_out, $img_logo, $logo_image_x, $logo_image_y, 0, 0, $logo_sx, $logo_sy);
		...
		elseif ( $image_type == IMAGETYPE_WEBP ) {
			imagewebp($img_out, $this->output_image_name);
		}
	...
	//..............................................................................
	// статический метод обрезания изобюражения
	//..............................................................................
	static function _crop($gd_img, $new_x, $new_y) {
		// определим размеры входного изображения
		$input_x 	= imagesx($gd_img);
		$input_y 	= imagesy($gd_img);
		...
		imagecopyresampled($img_res, $gd_img, 0, 0, 0, 0, $width_x, $width_y, $input_x, $input_y);
