...
class itEditor
	...
	public function get_title()
		...
		$data['name'] 		= $this->name;
		$data['no_date']	= !is_null($this->no_date) 		? $this->no_date 	: DEFAULT_NODATE;
		$data['no_related']	= !is_null($this->no_related) 	? $this->no_related	: DEFAULT_NORELATED;
		$data['no_lang']	= !is_null($this->no_lang) 		? $this->no_lang 	: DEFAULT_NOLANG;
		$data['no_moderate']= !is_null($this->no_moderate)	? $this->no_moderate: DEFAULT_NOMODERATE;
		$data['no_avatar'] 	= !is_null($this->no_avatar)	? $this->no_avatar 	: DEFAULT_NOAVATAR;
