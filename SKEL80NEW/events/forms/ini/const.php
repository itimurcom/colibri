...
definition($constants = [
	...
	'DEFAULT_FORMFIELD_TABLE'	=> 'formfields',
	...
	// itModal
	// стандартный размер всплывающего окна
	'DEFAULT_MODAL_SIZE'	=> 'medium',
	// small	: 320px
	// medium 	: 480px
	// large	: 640px
	// xlarge	: 960px
	...
	// стандартная анимаци для модального окна
	'DEFAULT_MODAL_ANIMATION'	=> 'fade',	// fadeAndPop, fadeAndUp, fade
	...
	'DEFAULT_FORM_ACTION' 		=> '/ed_field.php',
	'DEFAULT_FORM_METHOD'		=> 'POST',
// 	'DEFAULT_DATEPICKER_IMAGE'	=> 'date-button.png',
