<?php 
global $_LDJSON, $_RDFA, $_SCHEMA, $_CONTENT;
...
<!-- End Google Tag Manager -->
	<?=ready_value($_CONTENT['header'] ?? NULL)?>
<?=ready_value($_LDJSON)?>
...
<?=ready_value($_CONTENT['async'] ?? NULL)?>
<!-- <div id='wrapper'> -->
<?=get_iphone_menu();?>
<div class='site_container boxed rounded'>
<?=ready_value($_CONTENT['admin'] ?? NULL);?>
<?=ready_value($_CONTENT['error'] ?? NULL)?>
